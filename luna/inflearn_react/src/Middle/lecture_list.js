    ...
    return (
        ...
        <div className="lecture_list side_space">
            <div className="lecture_list_title">
                <p className="lecture_list_title_text">무료강의? 오히려 좋아 ✨</p>
            ...
            <div className="lecture_content">
                ...
                <br/><br/>
                <p className="lecture_title">인프콘 2022 다시보기</p>
                <p className="lecture_lecturer">인프런</p>
                <div className="lecture_star">
                    ...
                    <span className="lecture_star_number">(9)</span>
                </div><br/>
                <p className="lecture_price">무료</p>
                <div className="lecture_info">
                    <p className="lecture_people">+12800명</p>
                    <p className="lecture_update">업데이트</p>
                </div>
            </div>
            <div className="lecture_content">
                <img alt="lecture1" className="lecture_list_image" src="https://cdn.inflearn.com/public/courses/329211/cover/ea485515-6665-4e5c-acd7-157c2b8b08f3/infcon-apply-main.png" />
