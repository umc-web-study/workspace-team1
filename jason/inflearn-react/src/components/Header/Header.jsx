        ...
        <header className={"header"}>
            <div className={"container"}>
                <div className={"header_container"}>
                    <div className={"header_platforms"}>
                    ...
                    <div className={"header_knowledge"}>
                        <a href="#">지식공유 참여</a>
                    </div>
                </div>
            </div>
